...
public class UserResource extends ExceptionHandling  {
    ...
    public ResponseEntity<User> addNewUser(@RequestParam("firstName") String firstName,
                                           ...
                                           @RequestParam(value = "profileImage", required = false) MultipartFile profileImage) throws UserNotFoundException, UserNameExistException, EmailExistException, IOException, NotAnImageFileException, UserNotFoundException, UserNameExistException {
